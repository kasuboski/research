...
# Token signing secret for AshAuthentication (test only)
config :saas_starter, :token_signing_secret, "test_token_signing_secret_at_least_64_bytes_long_for_testing_purposes_only"
